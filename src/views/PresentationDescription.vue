                ...
                <div class="presentation-container im ">
                    <div id="wrapper-description">
                        ...
                        <div id="left" class="sub-description">
                            ...
                            <p class="text-justify description">{{presentation.description}}</p>
    ...
    export default {
        ...
        data: function () {
            return {
                sliderValue: 2,
                presentation: {
                    name: "i am a presentation",
                    speakers: [
                        {
                            img_path: require("../assets/img/Alan_Turing_Aged_16.jpg"),
                            name: "mahvahs"
                        },
                        {
                            img_path: require("../assets/img/Alan_Turing_Aged_16.jpg"),
                    ...
                    description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. " +
                        ...
                        "eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt." +
